...
LOCAL_SRC_FILES := libjniopencv_superres.so
include $(PREBUILT_SHARED_LIBRARY)
...
include $(CLEAR_VARS)
LOCAL_MODULE := libnative_camera_r4.1.1
LOCAL_SRC_FILES := libnative_camera_r4.1.1.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libnative_camera_r4.2.0
LOCAL_SRC_FILES := libnative_camera_r4.2.0.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libnative_camera_r4.3.0
LOCAL_SRC_FILES := libnative_camera_r4.3.0.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libnative_camera_r4.4.0
LOCAL_SRC_FILES := libnative_camera_r4.4.0.so
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES := libopencv_superres.so
include $(PREBUILT_SHARED_LIBRARY)
